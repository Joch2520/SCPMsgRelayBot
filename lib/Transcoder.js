  ...
  function D2TTranscoder (subject) {
    if(!(this instanceof D2TTranscoder)) {return new D2TTranscoder(subject)};
    this.subject = subject;
  }
  ...
  function Q2TTranscoder (subject) {
    if(!(this instanceof Q2TTranscoder)) {return new Q2TTranscoder(subject)};
    this.subject = subject;
  }
